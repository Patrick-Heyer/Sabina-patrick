...
class CWorkspace
{
  ...
  public:
    ...
    const double & MinX() const { return __Minima_pd_m[0] ; }
    const double & MinY() const { return __Minima_pd_m[1] ; }
    const double & MinZ() const { return __Minima_pd_m[2] ; }
    const double & MaxX() const { return __Maxima_pd_m[0] ; }
    const double & MaxY() const { return __Maxima_pd_m[1] ; }
    const double & MaxZ() const { return __Maxima_pd_m[2] ; }
