...
// 	string filevideo="VideosNEW/webcam1.avi";
    ...
    products_names[0]="coke";
    products_names[1]="seven_up";
    products_names[2]="lemon_tea";
    products_names[3]="pepsi";
    products_names[4]="mineral_water";
    products_names[5]="gatorade";
    products_names[6]="orange_juice";
    products_names[7]="apple_juice";
    products_names[8]="crackers";
    products_names[9]="wafer";
    products_names[10]="candy";
    products_names[11]="cookies";
    products_names[12]="chili";
    products_names[13]="dough";
    products_names[14]="tomatoe_sauce";
    products_names[15]="soy_sauce";
    products_names[16]="tofu";
    products_names[17]="tea_box";
    products_names[18]="cotton";
    products_names[19]="desinfectant";
    products_names[20]="hair_gel";
    products_names[21]="soap";
    products_names[22]="tooth_paste";
    products_names[23]="toilet_paper";
    products_names[24]="shampoo";
    products_names[25]="pad";
