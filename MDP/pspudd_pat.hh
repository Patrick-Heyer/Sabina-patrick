...
void* fill(DdManager *ddman, DdNode *value, DdNode *action, char * pfile, onum *ovars, rnum *vars, int numvars, int numovars,  Var_type *variables_temp, Var_type *val_variable );
void pQuery(DdManager *dd, DdNode *value, DdNode *action, char * pfile, onum *orig_vars, rnum *vars, int, int);
char* pQuery(DdManager *ddman, DdNode *value, DdNode *action, char * pfile, onum *ovars, rnum *vars, int numvars, int numovars, int *valores);
void pdd(DdNode *b);
