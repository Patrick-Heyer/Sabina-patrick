...
void GetTextureInfo (tga_header_t *header, gl_texture_tga *texinfo)
{
...
void ReadTGA8bits (FILE *fp, GLubyte *colormap, gl_texture_tga *texinfo)
{
    int i;
    GLubyte color;
...
void ReadTGA16bits (FILE *fp, gl_texture_tga *texinfo)
{
    int i;
...
void ReadTGA24bits (FILE *fp, gl_texture_tga *texinfo)
{
    int i;
...
void ReadTGA32bits (FILE *fp, gl_texture_tga *texinfo)
{
    int i;
...
void ReadTGAgray8bits (FILE *fp, gl_texture_tga *texinfo)
{
    int i;
...
void ReadTGAgray16bits (FILE *fp, gl_texture_tga *texinfo)
{
    int i;
...
void ReadTGA8bitsRLE (FILE *fp, GLubyte *colormap, gl_texture_tga *texinfo)
{
    int i, size;
    GLubyte color;
...
void ReadTGA16bitsRLE (FILE *fp, gl_texture_tga *texinfo)
{
    int i, size;
    unsigned short color;
    GLubyte packet_header;
...
void ReadTGA24bitsRLE (FILE *fp, gl_texture_tga *texinfo)
{
    int i, size;
    GLubyte rgb[3];
    GLubyte packet_header;
...
void ReadTGA32bitsRLE (FILE *fp, gl_texture_tga *texinfo)
{
    int i, size;
    GLubyte rgba[4];
    GLubyte packet_header;
...
void ReadTGAgray8bitsRLE (FILE *fp, gl_texture_tga *texinfo)
{
    int i, size;
    GLubyte color;
    GLubyte packet_header;
...
void ReadTGAgray16bitsRLE (FILE *fp, gl_texture_tga *texinfo)
{
    int i, size;
    GLubyte color, alpha;
    GLubyte packet_header;
...
gl_texture_tga *ReadTGAFile (const char *filename)
{
    FILE *fp;
    gl_texture_tga *texinfo;
    tga_header_t header;
    ...
    texinfo = (gl_texture_tga *)malloc (sizeof (gl_texture_tga));
